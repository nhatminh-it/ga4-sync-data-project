...
CREATE TABLE ga4_report (
    ...
    PRIMARY KEY (account_id, property_id, campaign_id, start_date, end_date)
);

CREATE INDEX idx_campaign_start_date ON ga4_report (account_id, property_id, campaign_id, start_date);
